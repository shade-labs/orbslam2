# Shade ORB-SLAM2
This is a shade fork of the original ORBSLAM-2. This repo fixes build issues with the original repo and gives working (prebuilt) docker images/docker files for
...
Pull our prebuilt docker images (built on intel processor x86_64):
...
## C++11 or C++0x Compiler and C++14
We use the new thread and chrono functionalities of C++11. Some dependencies require C++14.
